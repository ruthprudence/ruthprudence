...
In fourth grade my mom brought home an expensive Personal Computer, an Acer 486 DXII 50Mhz computer with a 420Mb harddrive a 2Mb of RAM, which I upgraded to 4Mb. 4 *mega* bytes :)
...
I initially attached the system to a local lithium-ion battery, but I eventually rerouted the wires to the front battery, ensuring the battery would never be flat (and always start, even if not driven for many weeks). I ended up augmenting a display panel to the interior front of the vehicle so I could monitor the solar system from the driver's seat.

#### Future Physical Projects
I would like to build/develop:
- rainwater harvesting system
- dehumidifier system that feeds indoor house plants
- radio receiver (possibly arduino) to sense utility meter signals
...
I first began programming during the summer of 2012, while I was living in Nebraska: I visited Nick Parlante's Python CodeBat and truly started at the very basics. I moved to Seattle and immediately enrolled in community college classes, eventually earning an Associate's Degree in IT -- Web Development. 
